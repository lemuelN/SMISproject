...
class sqlfunction extends DB_Connect{
	...
	function addUser($username,$fName,$pw,$type){
		$sql = "Insert into tbluseraccount (fldusername,fldfullName,fldpassword,flduserType) values('$username','$fName','$pw','$type')";
...
$sql = "Select fldStudent_No,fldStud_FirstName,fldStud_MiddleName,fldStud_LastName,fldGrade_Year_Lvl_Entered from tblstudentrecord where fldID='".$studID."'";
